 ...
 * @author gabri
 */
public class frmDesenv2 extends javax.swing.JFrame {

    /**
     * Creates new form frmDesenv2
     */
    public frmDesenv2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDesenv2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmDesenv2().setVisible(true);
            }
        });
    }
