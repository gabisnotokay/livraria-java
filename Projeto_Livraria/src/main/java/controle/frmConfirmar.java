 ...
 * @author gabri
 */
public class frmConfirmar extends javax.swing.JFrame {

    /**
     * Creates new form frmConfirmar
     */
    public frmConfirmar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Deseja confirmar sua compra?");
        ...
        jPanel2.setBackground(new java.awt.Color(24, 74, 170));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JOptionPane.showMessageDialog(null, "Recebemos seu pedido, obrigado pela preferência!!");
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConfirmar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmConfirmar().setVisible(true);
            }
        });
    }
