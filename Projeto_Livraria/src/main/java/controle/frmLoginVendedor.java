...
import controle.frmMenuVendedor;
import java.sql.SQLException;
import javax.swing.JOptionPane;
import javax.sql.*;

public class frmLoginVendedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Acesso à Livraria - Login Vendedor");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/controle/vendedor_resized (1).png"))); // NOI18N
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        try{
            String pesquisa = "select * from loginvendedor where usuario like '" + txt1.getText() + "' && senha = " + txt2.getText() + "";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmLoginVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmLoginVendedor().setVisible(true);
            }
        });
    }
